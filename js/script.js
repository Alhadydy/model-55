$(function () {
  // Blur event to hide collapsable navigation on small screens
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  $ajaxUtils.sendGetRequest(
    allCategoriesUrl,
    buildAndShowHomeHTML, // Call this function when server responds
...
function buildAndShowHomeHTML(categories) {
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      // Surround the chosen short name with quotes
